        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <input type="text" class="form-control" id="id" name="id"
              value="${id}" maxlength="20" required />
            <c:if test="${not empty errors['id']}">
              <p class="mt-2 fw-bold text-warning">${errors['id']}</p>
            </c:if>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-12">
            ...
            <input type="password" class="form-control" id="password" name="password"
              value="${password}" maxlength="20" required />
          ...
          <div class="col-12">
            ...
            <select class="form-select" id="school_cd" name="school_cd">
              ...
              <c:forEach var="school" items="${schoolList}">
                <option value="${school.cd}" <c:if test="${school_cd == school.cd}">selected</c:if>>${school.name}</option>
              </c:forEach>
            </select>
        ...
        <div class="row mb-3">
          <div class="col-12">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="is_admin" name="is_admin" <c:if test="${is_admin}">checked</c:if> />
